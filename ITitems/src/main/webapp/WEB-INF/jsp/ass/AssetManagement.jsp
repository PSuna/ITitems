...
function fn_egov_select_noticeList(pageNo) {
    ...
    document.frm.action = "<c:url value='${pageContext.request.contextPath}/ass/AssetManagement.do'/>";
    document.frm.submit(); 
}
</script>
</head>
								...
								<div class="condition2">
									<span class="lb">부서</span><label class="item f_select"
										for="sel1"><select id="searchOrgnzt" name="searchOrgnzt"
															...
															<option value="${orgnztId.code}" selected="selected"><c:out value="${orgnztId.codeNm}"/></option>
															</c:when>
															<c:otherwise>
									...
									<input id="prjNm" type="text" title="주소" maxlength="100" readonly="false" />
									 ...
									 <span class="lb">대분류</span> <label class="item f_select"
										...
										for="sel1"> <select id="middleCategory" name="searchdMCat"
														title="중분류">
															<option value='' label="선택하세요"/>
													</select>
										...
										type="date" name="startDate"> ― <input class="f_date"
