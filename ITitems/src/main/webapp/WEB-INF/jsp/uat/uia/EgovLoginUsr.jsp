					...
					<div class="layout">
						<div class="P_LOGIN">
							...
							<div class="pty_P_LOGIN_bottom">
								<img src="<c:url value='/'/>images/iteyes_logo.png"
									height="70px">
								<h1>자산관리 솔루션</h1>
								<!--  <p class="txt">로그인</p> -->
							</div>
									...
									<fieldset>
										...
										<div class="pty_flex">
											<div>
												<dl>
													<dt>
														<label for="memid">이메일주소</label>
													</dt>
													<dd>
														<input class="pdi" type="text" placeholder="아이디"
															style="width: 180px; margin-right: 10px;"
															title="사내 메일 주소를 입력하세요." id="id" name="id" maxlength="30" />@
														iteyes.co.kr
													</dd>
												</dl>
												...
												<dl>
													...
													<dd>
														<input type="password" maxlength="25" placeholder="비밀번호"
															title="비밀번호를 입력하세요." id="password" name="password"
															onkeydown="javascript:if (event.keyCode == 13) { actionLogin(); }" />

														<div class="bot pty_bot">
															<label for="chk" class="f_chk pty_f_chk"> <input
																type="checkbox" name="checkId" id="chk" title="ID 저장"
																onClick="javascript:saveid(document.loginForm);" /> <span>ID
																	저장</span>
															</label>
											...
											<a href="#LINK" class="btn_login"
												onclick="javascript:actionLogin()">로그인</a>
										</div>
										<a href="#LINK" class="pty_m_btn_login"
											onclick="javascript:actionLogin()">로그인</a>
