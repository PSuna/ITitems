...
function fncSelectRoleList() {
    ...
    varFrom.action = "<c:url value='/res/sec/rmt/EgovRoleList.do'/>";
    varFrom.submit();       
}
...
function fncRoleInsert() {
    ...
    var varFrom = document.getElementById("roleManage");
    varFrom.action = "<c:url value='/res/sec/rmt/EgovRoleInsert.do'/>";
...
function fncRoleUpdate() {
    var varFrom = document.getElementById("roleManage");
    varFrom.action = "<c:url value='/res/sec/rmt/EgovRoleUpdate.do'/>";
...
function fncRoleDelete() {
    var varFrom = document.getElementById("roleManage");
    varFrom.action = "<c:url value='/res/sec/rmt/EgovRoleDelete.do'/>";
                                ...
                                <div class="board_view2">
                                    <table summary="롤을 수정하는 테이블입니다.롤 코드,롤 명,롤 패턴,설명,롤 타입,롤 Sort,등록일자 정보를 담고 있습니다.">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="roleCode" id="roleCode" class="f_txt" type="text" value="<c:out value='${roleManage.roleCode}'/>" readonly="readonly" title="롤 코드" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="lb">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="roleCreatDe" id="roleCreatDe" class="f_txt" type="text" value="<c:out value='${roleManage.roleCreatDe}'/>" maxLength="50" title="등록일자" readonly="readonly"/>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
