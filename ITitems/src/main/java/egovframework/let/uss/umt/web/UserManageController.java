...
public class UserManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/umt/user/EgovUserMyPasswordUpdtView.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/umt/user/EgovMyPasswordUpdt.do")
	public String EgovMyPasswordUpdt(ModelMap model, @RequestParam Map<String, Object> commandMap, @ModelAttribute("searchVO") UserDefaultVO userSearchVO,
		...
		return "forward:/cmm/uss/myp/MyPageUpdt.do"+id;
	}
}