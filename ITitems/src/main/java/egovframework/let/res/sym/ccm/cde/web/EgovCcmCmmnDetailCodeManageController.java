package egovframework.let.res.sym.ccm.cde.web;
...
import egovframework.let.res.sym.ccm.cca.service.CmmnCode;
import egovframework.let.res.sym.ccm.cca.service.CmmnCodeVO;
import egovframework.let.res.sym.ccm.cca.service.EgovCcmCmmnCodeManageService;
import egovframework.let.res.sym.ccm.ccc.service.CmmnClCodeVO;
import egovframework.let.res.sym.ccm.ccc.service.EgovCcmCmmnClCodeManageService;
import egovframework.let.res.sym.ccm.cde.service.CmmnDetailCodeVO;
import egovframework.let.res.sym.ccm.cde.service.EgovCcmCmmnDetailCodeManageService;
...
public class EgovCcmCmmnDetailCodeManageController {
	...
	public String deleteCmmnDetailCode (@ModelAttribute("loginVO") LoginVO loginVO
        ...
        return "forward:" + path + "/sym/ccm/cde/EgovCcmCmmnDetailCodeList.do";
	}
	...
	public String insertCmmnDetailCode	(@ModelAttribute("loginVO") LoginVO loginVO
    	...
    	if   (cmmnDetailCode.getCodeId() == null
                ...
                return path + "/cmm/sym/ccm/EgovCcmCmmnDetailCodeRegist";
	...
	@RequestMapping(value="/sym/ccm/cde/EgovCcmCmmnDetailCodeDetail.do")
 	public String selectCmmnDetailCodeDetail (@ModelAttribute("loginVO") LoginVO loginVO
		...
		return path + "/cmm/sym/ccm/EgovCcmCmmnDetailCodeDetail";
	}
	...
	public String selectCmmnDetailCodeList (@ModelAttribute("loginVO") LoginVO loginVO
        ...
        return path + "/cmm/sym/ccm/EgovCcmCmmnDetailCodeList";
	}
	...
	public String updateCmmnDetailCode (@ModelAttribute("loginVO") LoginVO loginVO
    	...
    	if (sCmd.equals("")) {
    		...
    		return path + "/cmm/sym/ccm/EgovCcmCmmnDetailCodeModify";
