...
public class EgovUserInfManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserInfManageService {
     ...
     * 동호회 운영자 목록을 조회한다.
     * 
     * @see egovframework.let.res.cop.com.service.EgovUserInfManageService#selectClubOprtrList(egovframework.let.res.cop.com.service.UserInfVO)
     */
     ...
     * 동호회 사용자 목록을 조회한다.
     * 
     * @see egovframework.let.res.cop.com.service.EgovUserInfManageService#selectClubUserList(egovframework.let.res.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 관리자 목록을 조회한다.
     * 
     * @see egovframework.let.res.cop.com.service.EgovUserInfManageService#selectCmmntyMngrList(egovframework.let.res.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 사용자 목록을 조회한다.
     * 
     * @see egovframework.let.res.cop.com.service.EgovUserInfManageService#selectCmmntyUserList(egovframework.let.res.cop.com.service.UserInfVO)
     */
     ...
     * 사용자 정보에 대한 목록을 조회한다.
     * 
     * @see egovframework.let.res.cop.com.service.EgovUserInfManageService#selectUserList(egovframework.let.res.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see egovframework.let.res.cop.com.service.EgovUserInfManageService#selectAllClubUser(egovframework.let.res.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see egovframework.let.res.cop.com.service.EgovUserInfManageService#selectAllCmmntyUser(egovframework.let.res.cop.com.service.UserInfVO)
     */
