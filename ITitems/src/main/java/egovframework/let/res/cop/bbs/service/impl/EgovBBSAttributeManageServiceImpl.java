package egovframework.let.res.cop.bbs.service.impl;
...
import egovframework.let.res.cop.com.service.EgovUserInfManageService;
import egovframework.let.res.cop.com.service.UserInfVO;
import egovframework.let.res.cop.com.service.impl.BBSUseInfoManageDAO;
...
public class EgovBBSAttributeManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSAttributeManageService {
     ...
     * 등록된 게시판 속성정보를 삭제한다.
     *
     * @see egovframework.let.res.cop.bbs.brd.service.EgovBBSAttributeManageService#deleteBBSMasterInf(egovframework.let.res.cop.bbs.brd.service.BoardMaster)
     */
     ...
     * 신규 게시판 속성정보를 생성한다.
     *
     * @see egovframework.let.res.cop.bbs.brd.service.EgovBBSAttributeManageService#insertBBSMastetInf(egovframework.let.res.cop.bbs.brd.service.BoardMaster)
     */
     ...
     *
     * @see egovframework.let.res.cop.bbs.brd.service.EgovBBSAttributeManageService#selectAllBBSMasteInf(egovframework.let.res.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     *
     * @see egovframework.let.res.cop.bbs.brd.service.EgovBBSAttributeManageService#selectBBSMasterInf(egovframework.let.res.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     * 게시판 속성 정보의 목록을 조회 한다.
     *
     * @see egovframework.let.res.cop.bbs.brd.service.EgovBBSAttributeManageService#selectBBSMasterInfs(egovframework.let.res.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     * 게시판 속성정보를 수정한다.
     *
     * @see egovframework.let.res.cop.bbs.brd.service.EgovBBSAttributeManageService#updateBBSMasterInf(egovframework.let.res.cop.bbs.brd.service.BoardMaster)
     */
     ...
     * 템플릿의 유효여부를 점검한다.
     *
     * @see egovframework.let.res.cop.bbs.brd.service.EgovBBSAttributeManageService#validateTemplate(egovframework.let.res.cop.bbs.brd.service.BoardMasterVO)
     */
