...
public class ApprovalManageDAO extends EgovAbstractMapper {
	...
	// 모바일
	public List<ApprovalManageVO> mobSelectApprovalList(ApprovalDefaultVO approvalSearchVO){
		return selectList("approvalManageDAO.mobSelectApprovalList", approvalSearchVO);
	}
